...
import { changeActiveSearch, changeDisplay } from '../../../store/reducer/actions';
...
export const ControlBar = () => {
  ...
  const { isActiveTail, isActiveList, isSearchActive } = useSelector((state: IState) => state.mainReducer);
